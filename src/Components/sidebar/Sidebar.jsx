      ...
      <div className={`w-64 h-full ${isOpen ? 'block' : 'hidden'}`}>
        ...
        <nav className="mt-2">
          <ul className="space-y-1">
            ...
            <li>
              <a href="#" className="flex items-center px-4 py-3 text-sm font-medium text-white bg-green-500 border-l-4 border-green-600">
            ...
            {/* Accounts */}
            <li>
              <a href="#" className="flex items-center justify-between px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-gray-900">
